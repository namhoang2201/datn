...
import ProductFullDetail from 'src/simi/App/datn/RootComponents/Product/ProductFullDetail';
require('./styles.scss');
    ...
    render() {
        ...
        const dataModal = (props) => {
            ...
            if (sku)
                ...
                // add handle wishlist product url key 
                variables.urlKey = props.product_url_key ? props.product_url_key : props.url_key 
