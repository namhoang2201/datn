        ...
        return (
            <div className='address-book__container'>
                <div className='dash-column-box'>
                    ...
                    {defaultBilling && <Link className='edit-item' to={`/new-address.html/${defaultBilling.id}`}><span className="icon-pencil" title={Identify.__("Edit")} /></Link>}
                </div>
                <div className={`dash-column-box`}>
                    <div className="box-item-address">
                        <div className='box-title'>
                    ...
                    {defaultShipping && <Link className='edit-item' to={`/new-address.html/${defaultShipping.id}`}><span className="icon-pencil" title={Identify.__("Edit")} /></Link>}
                </div>
            </div>
        );
    }
