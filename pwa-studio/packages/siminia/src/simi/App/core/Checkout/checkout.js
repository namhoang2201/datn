...
import {beginCheckout, submitShippingAddress, submitBillingAddress, submitOrder, submitShippingMethod } from 'src/simi/Redux/actions/simiactions';
...
class Checkout extends Component {
    ...
    get checkoutInner() {
        ...
        const { cart, checkout, editOrder, submitShippingMethod, submitShippingAddress, submitOrder, submitPaymentMethod,
        ...
        const stepProps = {
            availableShippingMethods, billingAddress, cancelCheckout, cart, cartCurrencyCode, editOrder, editing,
